export default function FooterBottom({ className = '', disabled, children, ...props }) {
    return (
        <footer
            {...props}
            className={
                `footer px-10 py-4 border-t bg-base-300 text-base-content border-base-300  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${
                    disabled && 'opacity-25'
                } ` + className
            }
            disabled={disabled}
