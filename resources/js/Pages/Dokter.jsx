...
export default function JasaPelayanan({ auth, data, data_jp, data_dokter }) {
  ...
  const [dataSet_jp, setData_jp] = useState(data_jp);
  ...
  const handleModalSubmit = (e) => {
    ...
    axios
      .post('/add-dokter', { nama_dokter: namaDokter, nomor_pegawai: nomorPegawai })
      .then((response) => {
        setNamaDokter('');
        setNomorPegawai('');
          ...
          <div className="w-full">
            <div className="p-4 flex">
              ...
              <div className="flex-1 animate__animated animate__fadeInUp animate__slow text-center">
                <h1 className="text-8xl">
                  {dataSet_jp[0] && dataSet[0] ? (((dataSet_jp[0].jl / 100) * (dataSet[0].jp / 100)) * 100).toFixed(0) : '0'}
                  %
                </h1>
            ...
            <div className="p-4  mt-10">
              <div className="flex justify-end mb-2 animate__animated animate__fadeInUp animate__slow">
                <label className="btn btn-sm btn-success" htmlFor="modalAddDokter">
                  <i className="fa fa-plus mr-2"></i> Tambah dokter
                </label>
              </div>
              <input type="checkbox" id="modalAddDokter" className="modal-toggle" />
              <div className="modal">
                <div className="modal-box relative">
                  <label htmlFor="modalAddDokter" className="btn btn-sm btn-circle absolute right-2 top-2">
                    ✕
                  </label>
                  ...
                  <form onSubmit={handleModalSubmit}>
                    ...
                    <div className="py-4">
                      <label htmlFor="inputNomorPegawai" className="block mb-2">
                        Nomor Pegawai
                      </label>
                      <input
                        type="text"
                        id="inputNomorPegawai"
                        className="input input-bordered w-full"
                        value={nomorPegawai}
                    ...
                    <div className="mt-6 flex justify-end">
                      <button type="submit" className="btn btn-primary btn-sm" disabled={!namaDokter}>
                        Submit
                      </button>
                    </div>
                  </form>
                    ...
                    <table className="table table-compact w-full">
                      <thead>
                        <tr>
                          ...
                          <th className="bg-base-300">Nomor Pegawai</th>
          ...
          <div className="modal modal-open">
            <div className="modal-box">
              ...
              <div className="modal-action">
                <button className="btn btn-error mr-2" onClick={handleDeleteDokter}>
                  Hapus
                </button>
