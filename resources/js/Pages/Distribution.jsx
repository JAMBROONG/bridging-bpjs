...
import DashboardOutputDistribution from '@/Components/DashboardOutputDistribution';
import {ToastContainer, toast} from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';

export default function Distribution({auth, file}) {
    console.log(file);
    const [count,
    ...
    const handleSubmit = async(e) => {
        ...
        if ((isValidFile1 && isValidFile3) || (isValidFile2 && isValidFile4) || (isValidFile1 && isValidFile2 && isValidFile3 && isValidFile4)) {
            ...
            try {
                const response = await axios.post('/upload-distribution', formData, {
                    headers: {
                        'Content-Type': 'multipart/formdata'
                    }
                });
                setDataFile(response.data.file);
                const dataElements = <DashboardOutputDistribution/>;
            ...
            <div className=" bg-base-200">
                <div className="max-w-7xl pt-3 py-20 mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-5 mt-10">
                        <h1 className="text-5xl font-bold text-center mb-5">Allocation and Distribution</h1>
                        <ul className="steps">
                            <li
