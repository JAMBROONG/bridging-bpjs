...
export default function DistributionReportAll({auth, data}) {
            ...
            <div className="bg-base-200">
                <div
                    ...
                    <ul>
                            ...
                            <li>
                                <Link  href={route('distribution.all')}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                    ...
                                    Laporan Allocation and Distribution
                                </Link>
                            </li>
                        </ul>
                    </div>
                    <div className="w-full mt-10">
                        <div className="p-4 flex">
                            <div className="flex-1 animate__animated animate__fadeInUp animate__slow">
                                <h1 className="text-5xl">Laporan Allocation & Distribution Secara Keseluruhan</h1>
                            </div>
